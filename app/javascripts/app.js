...
window.App = {
  ...
  createNewGame: function() {
    TicTacToe.new({from:account, value:web3.toWei(0.01,"ether"), gas:3000000}).then(instance => {
  ...
  joinGame: function() {
    ...
    console.log(typeof gameAddress);
    if(gameAddress != null) {
      TicTacToe.at(gameAddress).then(instance => {
        ...
        return ticTacToeInstance.joinGame({from:account, value:web3.toWei(0.01, "ether"), gas:3000000});
      }).then(txResult => {
        $(".in-game").show();
        $(".game-start").hide();
